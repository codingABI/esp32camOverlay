 ...
 * Description: Example sketch to show, how to draw text or lines on a esp32-cam captured photo and save the picture on a SD card
 * 
 * This could be useful, for example, if you want to show a timestamp, logo oder label on a photo.
